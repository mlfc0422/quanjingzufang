...
public class HouseResources implements Serializable {
    ...
    private Boolean rentMethod;        // 租赁方式，1-整租，2-合租
    private Boolean paymentMethod;      // 支付方式，1-付一押一，2-付三押一，3-付六押一，4-年付押一，5-其它
    ...
    private Boolean time;              // 看房时间，1-上午，2-中午，3-下午，4-晚上，5-全天
